...
log = logging.getLogger("subdownloader.SDDBServer")
...
class SDDBServerError(Exception):
    pass
...
class SDDBServer(object):
    ...
    def __init__(self, options):
        self.log = logging.getLogger("subdownloader.SDDBServer.SDDBServer")
        self.log.debug("Creating SDDBServer with options= %s",  options)
...
#        self.set_proxy(options.proxy)
    ...
    def json_request(self, function,  arguments):
        json_request = TimeoutFunction(self._json_request)
        try:
            return json_request(function,  arguments)
